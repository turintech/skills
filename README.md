...
| `cli-follow-along` | Show the matching Artemis Web UI page while work happens |
| `platform-tour` | Show how a task is done in the Web UI by doing it in the user's Chrome, no CLI |
